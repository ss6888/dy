...
//let sub = '';// 留空则显示原版内容
let sub = 'dy.jzg899.workers.dev';// 内置优选订阅生成器，
let subconverter = 'dyq.oceanus.cloudns.org';// clash订阅转换后端，目前使用自己的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/ss6888/dy/main/ACL4SSR_Mini_MultiMode.ini"; //订阅配置文件
